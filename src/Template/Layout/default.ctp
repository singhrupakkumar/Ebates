...
<footer>
	...
	<div class="container">
		<div class="row">
			<p>Domain Name.2017.All rights reserved</p>
		</div>
	</div>
	</div>
...
<script type="text/javascript">
            ...
            else
            {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        {
                            $(".message").html('<span style="color:green;">Please make sure you enter a valid email address.</span>');
                        }
                    }
                });
            }
    ...
    jQuery("#s").autocomplete({
		...
		return jQuery("<li></li>")
			...
			.append("<a><img width='40' src='https://rupak.crystalbiltech.com/affiliate/images/large/" + item.image + "' /> " + item.name + "</a>")
			.appendTo(ul)
	};
	</script>
